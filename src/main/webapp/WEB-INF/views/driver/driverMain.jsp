...
<!-- 	hi hello -->
<!-- 	</div> -->
	<div class="first clearfix" data-aos="fade-right">
		<div class="f1">
	...
	<div class="second clearfix" data-aos="fade-left">
		<div class="s1">
			...
			<br>
			<a href="./carpoolWrite"><button>등록하기→</button></a>
		</div>
		<img src="/assets/images/road1.jpg">
	</div>
	<div class="third clearfix" data-aos="fade-right">
		...
		<div class="t1">
			...
			원하는 장소와 기간을 설정하여 등록할 수 있습니다.</span>
			<br>
			<a href="./hitchWrite"><button>등록하기→</button></a>
		</div>
	</div>
	<div class="fourth clearfix" data-aos="fade-left" >
		<div class="f1">
			...
			<br>
			<a href="./mateWrite"><button>등록하기→</button></a>
		</div>
		<img src="/assets/images/road1.jpg">
	</div>
</div>
